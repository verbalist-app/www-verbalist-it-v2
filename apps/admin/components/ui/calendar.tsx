  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative border border-input shadow-xs rounded-md has-focus:outline-none has-focus:ring-0',
