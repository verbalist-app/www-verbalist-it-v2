...
/**
 * Wallpaper — backdrop colorato con noise overlay, importato dal kit Oatmeal del marketing site.
 * Usabile in dashboard per onboarding splash, welcome screens, empty states, success/upgrade pages.
 *
 * Stessi 4 colori del marketing (blue, purple, green, brown) per mantenere brand consistency
 * tra apps/web e apps/dashboard.
 */
